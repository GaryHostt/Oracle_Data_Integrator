...
- These two blog posts focus on connecting object storage and ADW/ATP to ODI. To connect to object storage in ODI, the PEM key you use must have a passphrase. In order to work with the compressed BICC extracts in object storage, you must first make an object storage topology and then the BICC toplology. If you have problems with loading your data into ADW, please consult the load operation queries, in this [link](https://docs.oracle.com/en/cloud/paas/autonomous-data-warehouse-cloud/user/load-data-cloud-monitor.html#GUID-657A579F-CF44-458B-8C97-3E50D0C98006). You may need to reconfigure the target tables in ADW to match the columns in your BICC extract if something like your column size is different from the default. 
